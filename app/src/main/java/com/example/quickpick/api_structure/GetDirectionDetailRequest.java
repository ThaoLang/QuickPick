...
public class GetDirectionDetailRequest {
    ...
    public GetDirectionDetailRequest(String idToken, String userId, String systemKey, String startAddress, String endAddress) {
