...
import com.example.quickpick.main_fragments.activity.OngoingBookingDetail;
...
public class BookingOngoingAdapter extends RecyclerView.Adapter<Booking_view_holder> {
    private Context _context;
    private List<Booking> _data = null;


    public BookingOngoingAdapter(Context context, List<Booking> data)
    {
        _context = context;
        if(_data != null)
        {
    ...
    public void onBindViewHolder(@NonNull Booking_view_holder holder, int position) {
        ...
        holder.setItemClickListener(new ItemClickListener() {
            ...
            public void onClick(View view, int position, boolean isLongClick) {
                ...
                Intent intent = new Intent(_context, OngoingBookingDetail.class);
